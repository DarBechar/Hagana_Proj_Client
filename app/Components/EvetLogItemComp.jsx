    ...
    >
      <View style={styles.content}>
        ...
        <View style={styles.detailsRow}>
          <Text style={styles.location}>{event.locationName || 'מיקום לא ידוע'}</Text>
          <MaterialIcons name="location-on" size={16} color="#888" style={styles.icon} />
        </View>
        
        <View style={styles.detailsRow}>
          <Text style={styles.date}>{formatDateTime(event.openingDate)}</Text>
          <MaterialIcons name="access-time" size={16} color="#888" style={styles.icon} />
        </View>
